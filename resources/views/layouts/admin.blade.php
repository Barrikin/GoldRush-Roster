        ...
        <nav class="main-header navbar navbar-expand bg-dark navbar-light border-bottom">
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown notifications-menu">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg bg-dark dropdown-menu-right">
                ...
                <li class="nav-item">
                    <a href="{{ route("admin.messenger.showInbox") }}" class="{{ request()->is("admin/messenger") || request()->is("admin/messenger/*") ? "active" : "" }} nav-link" title="{{ trans('global.messages') }}">
                ...
                @if(file_exists(app_path('Http/Controllers/Auth/ChangePasswordController.php')))
                    @can('profile_password_edit')
                        <li class="nav-item">
                            <a class="nav-link {{ request()->is('profile/password') || request()->is('profile/password/*') ? 'active' : '' }}" href="{{ route('profile.password.edit') }}" title="{{ trans('global.change_password') }}">
                ...
                @endif
                <li class="nav-item">
                    <a href="#" class="nav-link" onclick="event.preventDefault(); document.getElementById('logoutform').submit();" title="{{ trans('global.logout') }}">
                        <p>
