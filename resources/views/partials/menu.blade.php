                ...
                @can('user_management_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/permissions*") ? "menu-open" : "" }} {{ request()->is("admin/roles*") ? "menu-open" : "" }} {{ request()->is("admin/user-alerts*") ? "menu-open" : "" }} {{ request()->is("admin/audit-logs*") ? "menu-open" : "" }} {{ request()->is("admin/ranks*") ? "menu-open" : "" }}">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            @can('rank_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.ranks.index") }}" class="nav-link {{ request()->is("admin/ranks") || request()->is("admin/ranks/*") ? "active" : "" }}">
                                        <i class="fa-fw nav-icon fas fa-briefcase">
                    ...
                    <li class="nav-item has-treeview {{ request()->is("admin/users*") ? "menu-open" : "" }} {{ request()->is("admin/disciplinaries*") ? "menu-open" : "" }} {{ request()->is("admin/sops*") ? "menu-open" : "" }} {{ request()->is("admin/certifications*") ? "menu-open" : "" }} {{ request()->is("admin/comments*") ? "menu-open" : "" }} {{ request()->is("admin/*") ? "menu-open" : "" }}">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            @can('disciplinary_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.disciplinaries.index") }}" class="nav-link {{ request()->is("admin/disciplinaries") || request()->is("admin/disciplinaries/*") ? "active" : "" }}">
                                        <i class="fa-fw nav-icon fas fa-cogs">
                            ...
                            @can('sop_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.sops.index") }}" class="nav-link {{ request()->is("admin/sops") || request()->is("admin/sops/*") ? "active" : "" }}">
                                        <i class="fa-fw nav-icon fas fa-cogs">
                            ...
                            @can('fto_access')
                                <li class="nav-item has-treeview {{ request()->is("admin/courses*") ? "menu-open" : "" }} {{ request()->is("admin/trainings*") ? "menu-open" : "" }} {{ request()->is("admin/sop-sign-offs*") ? "menu-open" : "" }}">
                                    <a class="nav-link nav-dropdown-toggle {{ request()->is("admin/courses*") ? "active" : "" }} {{ request()->is("admin/trainings*") ? "active" : "" }} {{ request()->is("admin/sop-sign-offs*") ? "active" : "" }}" href="#">
                                        <i class="fa-fw nav-icon fas fa-cogs">
                                    ...
                                    <ul class="nav nav-treeview">
                                        ...
                                        @can('sop_sign_off_access')
                                            <li class="nav-item">
                                                <a href="{{ route("admin.sop-sign-offs.index") }}" class="nav-link {{ request()->is("admin/sop-sign-offs") || request()->is("admin/sop-sign-offs/*") ? "active" : "" }}">
                                                    <i class="fa-fw nav-icon fas fa-cogs">
